...
//403,404错误提示
Route::get('/403', array('as' => '403', 'uses' => '\App\Http\Controllers\Frontend\SiteController@message_403'));
Route::get('/404', array('as' => '404', 'uses' => '\App\Http\Controllers\Frontend\SiteController@message_404'));
//内容Node
