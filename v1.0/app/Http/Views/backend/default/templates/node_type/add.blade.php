...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">添加内容类型</h3>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="form-group">
            ...
            <input name="name" class="form-control" maxlength="32" required="" value='{{Input::old('name')}}'>
        </div>
        <div class="form-group">
            <label>描述</label>
        ...
        <div class="form-group">
            ...
            <input name="type" class="form-control" maxlength="64" required="" value='{{Input::old('type')}}'>
